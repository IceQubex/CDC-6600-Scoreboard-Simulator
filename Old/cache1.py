...
class inst:
    ...
    def print(self):
        print(self.inst, self.fetch, self.issue, self.read, self.exec, self.write, self.raw, self.waw, self.struct, self.status, self.status2)
...
class scoreboard:
    ...
    def simulate(self, instructions_list):
        ...
        return self.complete, len(self.complete), len(self.complete) - self.totalImiss, self.totalD, self.totalD - self.totalDmiss
